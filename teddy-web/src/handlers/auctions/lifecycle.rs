//! Auction lifecycle endpoint implementations

use crate::define_route_error;
use crate::dto::auctions::{AuctionResultResponse, AuctionStatsResponse};
use teddy_services::{AuctionService, AuctionServiceError};
...
pub async fn force_end_auction(
    ...
    let result = AuctionService::force_end_auction(pool.get_ref(), &item_id).await?;
