...
impl ItemService {
    ...
    pub async fn get_all_items(pool: &PgPool) -> Result<Vec<Item>, ItemServiceError> {
        let items = sqlx::query!(
            r#"SELECT item_id, name, price, currently, buy_price, number_of_bids,
        ...
        for item_row in items {
            ...
            result_items.push(Item {
                ...
                currently: item_row.currently.unwrap_or_default(),
                ...
                ends: item_row.ends.map(|dt| dt.and_utc()).unwrap_or_else(|| {
                    DateTime::<Utc>::from_naive_utc_and_offset(NaiveDateTime::default(), Utc)
                }),
    ...
    pub async fn update_item(
        ...
        let rows_affected = sqlx::query_unchecked!(
            r#"UPDATE items SET listing_type = $1, name = $2, price = $3, currently = $4, buy_price = $5,
               location = $6, country = $7, latitude = $8, longitude = $9, started = $10, ends = $11, description = $12,
               seller_user_id = $13, seller_rating = $14, condition = $15, shipping_cost = $16
               WHERE item_id = $17"#,
