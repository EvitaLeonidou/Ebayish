...
const Id: React.FC<{ className?: string }> = ({ className }) => (
  <svg
  ...
  >
    <g fill="currentColor">
      <path
        d="M216 48H40a8 8 0 0 0-8 8v144a8 8 0 0 0 8 8h176a8 8 0 0 0 8-8V56a8 8 0 0 0-8-8M96 144a24 24 0 1 1 24-24a24 24 0 0 1-24 24"
        opacity=".2"
      />
