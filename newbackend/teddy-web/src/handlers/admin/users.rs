// teddy-web/src/handlers/admin/users.rs
...
use crate::errors::users::{VerifyUserError, SuspendUserError, ActivateUserError, GetAllUsersError};

#[tracing::instrument(name = "Get pending users", skip(pool))]
pub async fn get_pending_users(pool: web::Data<PgPool>) -> Result<HttpResponse, VerifyUserError> {
